...
<div class="container">
    <a href="../Index.php" class="btn btn-dark boton">Regresar</a>
    <a href="GenerarExcel.php" class="btn btn-success boton">Generar Excel</a>
    <a href="" class="btn btn-warning boton" onclick="window.print()">Imprimir</a>
    <!-- <a href="/Reportes/GenerarPDF.php" class="btn btn-primary boton">Generar PDF</a> -->
</div>
